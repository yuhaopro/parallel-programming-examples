 ...
 * 2. consumer thread writes to local var total with value of global buffer data = 0 (becoz race condition)
...
int main(int argc, char *argv[]) {
  ...
  pthread_attr_setscope(&attr, PTHREAD_SCOPE_SYSTEM); // all threads from different processes will compete with each other 
